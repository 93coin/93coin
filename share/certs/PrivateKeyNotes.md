...
unlocked to sign the NinetyThreeCoin-Qt.app bundle.
...
allowing somebody to distribute a NinetyThreeCoin-Qt.app or ninetythreecoin-qt-setup.exe with a valid
...
that the ninetythreecoin-qt.exe file inside the installer had not been tampered with.
