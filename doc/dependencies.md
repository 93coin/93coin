...
These are the dependencies currently used by NinetyThreeCoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/ninetythreecoinnl
Keybase  - https://keybase.io/team/ninetythreecoin/
