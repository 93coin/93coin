    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextNinetyThreeCoin   = QChar(0xA9)+QString(" %1 ").arg(2023) + QString("The NinetyThreeCoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextNinetyThreeCoin);
    }
