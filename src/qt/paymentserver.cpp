...
const QString BITCOIN_IPC_PREFIX("ninetythreecoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/ninetythreecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ninetythreecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ninetythreecoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ninetythreecoin: links
...
//
// OSX-specific way of handling ninetythreecoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ninetythreecoin: URIs
