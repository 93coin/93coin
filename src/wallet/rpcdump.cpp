...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"ninetythreecoinaddress\"\n"
            "\nReveals the private key corresponding to 'ninetythreecoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"ninetythreecoinaddress\"   (string, required) The ninetythreecoin address for the private key\n"
            "\nResult:\n"
