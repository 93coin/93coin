...
#if defined(NDEBUG)
# error "NinetyThreeCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "NinetyThreeCoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        // NinetyThreeCoin: Minimum fee check
...
void ThreadScriptCheck() {
    RenameThread("ninetythreecoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // NinetyThreeCoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // NinetyThreeCoin also requires low S in sigs
