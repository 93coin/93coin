 ...
 * between ninetythreecoind, and ninetythreecoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("ninetythreecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/93coin/93coin>";
    const std::string URL_WEBSITE = "<https://93coin.us/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The NinetyThreeCoin Developers", 2023)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find NinetyThreeCoin useful. "
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("ninetythreecoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("NinetyThreeCoin More version %s\n", FormatFullVersion());
}
