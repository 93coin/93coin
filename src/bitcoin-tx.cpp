...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ninetythreecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ninetythreecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ninetythreecoin transaction") + "\n" +
              "  ninetythreecoin-tx [options] -create [commands]   " + _("Create hex-encoded ninetythreecoin transaction") + "\n" +
              "\n";
